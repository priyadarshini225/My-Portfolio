  ...
  return (
    <section id="interests"className="scroll-mt-20 p-6 bg-white dark:bg-gray-900  shadow-md">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-3">
        I’m a passionate artist with a love for creating lifelike portraits.<br /> My Insta portfolio includes over <strong>50+ commissioned artworks</strong> using pencil, charcoal, and watercolor mediums.
      </p>
